...
export class RegisterPersonalDataComponent implements OnInit {
  ...
  private initFormControlls(): void {
    this.personalDataForm = this.formBuilder.group({
      ...
      personal_birthday:        ['', [Validators.required, Validators.minLength(10)]],
      personal_gender:          ['', [Validators.required]],
      personal_phone:           ['', []],
      personal_cellphone:       ['', [Validators.required, Validators.minLength(15)]],
      residential_zip_code:     ['', [Validators.required, Validators.minLength(9)]],
